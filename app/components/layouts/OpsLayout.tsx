...
export function OpsLayout({ 
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  isActive ? "text-trm-primary" : "text-gray-400"
                )}
              >
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden lg:fixed lg:top-0 lg:left-0 lg:z-50 lg:h-full lg:w-72 lg:bg-white lg:shadow-xl lg:flex lg:flex-col">
        {/* Logo */}
      ...
      <div className="lg:pl-72 pb-20 lg:pb-0">
        {/* Top Bar */}
        <header className="h-16 lg:h-20 bg-white border-b border-gray-100 flex items-center px-4 lg:px-8 sticky top-0 z-20">
          <button
          ...
          <div className="lg:hidden flex items-center gap-2">
            <img src="/logo.png" alt="TRM" className="h-8 w-auto" />
            <span className="font-bold text-trm-red font-display">TRM Ops</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:block w-10 h-10 rounded-xl bg-trm-red/10 flex items-center justify-center">
              <span className="text-trm-red font-semibold">
